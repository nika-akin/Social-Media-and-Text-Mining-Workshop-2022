...
#I tried: `parse_date_time(mental$date, "a b d H:M:S Y")` to no avail
```{r}
...
# Format the date variable as "YYYY-MM-DD"
mental$formatted_date <- format(mental$date_any , "%Y-%m-%d")
```

```{r}
mental$formatted_date <-as_date(mental$formatted_date)
```
